...
exports.updateMosquitoValidator = exports.createMosquitonValidator = exports.uploadMosquito = void 0;
const express_validator_1 = require("express-validator");
const multer_1 = __importDefault(require("multer"));
const response_1 = __importDefault(require("../response"));
const storage = multer_1.default.diskStorage({
    destination: (req, file, cb) => {
        cb(null, "uploads/mosquito/");
    },
...
const uploadMosquito = (0, multer_1.default)({
    storage,
    fileFilter,
    limits: { fileSize: 10 * 1024 * 1024 },
});
exports.uploadMosquito = uploadMosquito;
const createMosquitonValidator = [
    (req, res, next) => {
...
exports.createMosquitonValidator = createMosquitonValidator;
const updateMosquitoValidator = [
...
exports.updateMosquitoValidator = updateMosquitoValidator;
